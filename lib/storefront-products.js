...
const ECOWARE_LOCAL_IMAGES = {
  bowl: "/images/bowl-240ml.png",
  box: "/images/container-8x8.png",
  "plate-3cp": "/images/plate-3cp.png",
  "tray-5cp": "/images/plate-5cp.png",
  "plate-9": "/images/plate-9-compartment.png",
  "plate-12": "/images/plate-12.png"
};
...
export async function getStorefrontProducts(
  ...
  return products.map((product) => {
    ...
    const localEcowareImage =
      product.storefront === PUBLIC_STOREFRONTS.ECOWARE
        ? ECOWARE_LOCAL_IMAGES[productId] || null
        : null;
