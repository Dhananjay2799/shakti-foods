...
const WHOLESALE_STOREFRONT = "ecoware";
...
export async function updateWholesaleInquiry(
  ...
  revalidatePath(
    `/admin/ecoware/wholesale/${inquiryId}`
  );
...
export async function createWholesaleQuote(
  ...
  redirect(
    `/admin/ecoware/wholesale/${inquiryId}?quote=${quote.id}`
  );
}
...
export async function sendWholesaleQuote(
  ...
  if (
    ...
    redirect(
      `/admin/ecoware/wholesale/${quote.inquiry_id}`
    );
  }
  ...
  redirect(
    `/admin/ecoware/wholesale/${quote.inquiry_id}?quoteSent=${quote.id}`
  );
}
...
export async function convertWholesaleQuoteToOrder(
  ...
  if (
    ...
    redirect(
      `/admin/ecoware/orders/${quote.converted_order_id}`
    );
  }
  ...
  if (
    ...
    if (
      ...
      redirect(
        `/admin/ecoware/orders/${latestQuote.converted_order_id}`
      );
    }
  ...
  revalidatePath(
    "/admin/ecoware/orders"
  );

  revalidatePath(
    `/admin/ecoware/orders/${order.id}`
  );
