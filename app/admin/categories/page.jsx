...
export default async function CategoriesPage({
  ...
  const created =
    String(params.created || "") === "1";

  const updated =
    String(params.updated || "") === "1";

  const deleted =
    String(params.deleted || "") === "1";

  const reordered =
    String(params.reordered || "") === "1";

  const position =
    String(params.position || "");

  const editId =
    String(params.edit || "").trim();
    ...
    <main className="min-h-screen bg-[#f8f6f1]">
      <div className="mx-auto max-w-6xl py-3">
          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-black/50">
                Add, edit, delete, activate, and reorder
                product categories.
              </p>
            </div>
        ...
        <div className="mt-5 grid gap-3">
          {created ? (
            <Message>
              Category created successfully and placed
          ...
          {position === "first" ? (
            <Message type="info">
              This category is already first.
            </Message>
          ) : null}

          {position === "last" ? (
            <Message type="info">
              This category is already last.
            </Message>
          ) : null}
        </div>
            ...
            <div className="mt-5 grid gap-4">
              ...
              <label className="grid gap-2">
                ...
                <span className="text-xs leading-5 text-black/45">
                  Existing products update automatically
                ...
                <label className="flex items-start gap-3 rounded-2xl bg-[#faf8f4] p-4">
                  ...
                  <span>
                    ...
                    <span className="mt-1 block text-xs leading-5 text-black/50">
                      Active categories appear in product
          ...
          <section className="rounded-[1.75rem] border border-black/5 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-black/50">
                  Use the arrow buttons to change the display
                  order.
                </p>
              </div>
            </div>
              ...
              {categories.length === 0 ? (
                <div className="rounded-2xl border border-dashed border-black/15 bg-[#faf8f4] p-8 text-center">
                  ...
                  <p className="mt-2 text-sm text-black/50">
                    Create your first product category using
                    the form.
                  </p>
                </div>
              ) : null}
