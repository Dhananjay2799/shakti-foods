        ...
        <div className="mt-6 rounded-[2rem] bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-8 rounded-2xl border border-black/10 p-5">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              ...
              <InfoCard
                label="Internal Subscription ID"
                value={
                  subscription.id
                }
              />
          ...
          <div className="mt-8 rounded-[1.5rem] border border-black/10 bg-[#faf8f4] p-5">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-black/55">
              Actions are sent directly to the payment provider.
              The PayPal and Stripe webhooks keep the Shakti Foods
              subscription status synchronized afterward.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              {canSuspend ? (
                <form
                  action={`/api/admin/subscriptions/${subscription.id}/suspend`}
                  method="POST"
                >
                  <button
                    type="submit"
              ...
              {canReactivate ? (
                <form
                  action={`/api/admin/subscriptions/${subscription.id}/reactivate`}
                  method="POST"
                >
                  <button
                    type="submit"
              ...
              {canCancel ? (
                <form
                  action={`/api/admin/subscriptions/${subscription.id}/cancel`}
                  method="POST"
                >
                  <button
                    type="submit"
...
function InfoCard({
  ...
  return (
    <div className="min-w-0 rounded-2xl bg-[#faf8f4] p-4">
      ...
      <div className="mt-2 break-words font-bold">
        {value}
      </div>
    </div>
  );
