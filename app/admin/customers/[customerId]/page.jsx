  ...
  return (
    <main className="min-h-screen bg-[#f8f6f1]">
      <div className="mx-auto max-w-7xl px-5 py-8 md:px-8 md:py-12">
        ...
        {/* Step 1.B: Replaced top button block to append Customer Settings path */}
        <div className="flex flex-wrap items-center justify-between gap-4">
          <Link href="/admin/customers" className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-bold text-black shadow-sm transition hover:bg-[#f1eadf]">
            <ArrowLeft size={17} />
            Back to Customers
          </Link>
          <div className="flex flex-wrap gap-3">
            <Link href={`/admin/customers/${customerId}/settings`} className="inline-flex items-center gap-2 rounded-full bg-[#f1eadf] px-5 py-3 text-sm font-bold text-black transition hover:bg-[#e6dac7]">
              <Settings size={17} /> Customer Settings
            </Link>
            <Link href="/admin/orders" className="inline-flex items-center gap-2 rounded-full bg-black px-5 py-3 text-sm font-bold text-white transition hover:bg-black/80">
              <ShoppingBag size={17} />
              All Orders
            </Link>
          </div>
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[0.8fr_1.2fr]">
          <aside className="grid content-start gap-6">
            ...
            {/* Step 1.D: Replaced inline edit section block with compact Summary Metadata card */}
            <section className="rounded-[2rem] border border-black/5 bg-white p-5 shadow-sm md:p-6">
              <div className="flex items-center gap-3">
                <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#f1eadf] text-black">
                  <Settings size={21} />
              ...
              <Link href={`/admin/customers/${customerId}/settings`} className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-black px-5 py-3 text-sm font-bold text-white transition hover:bg-black/80">
                        ...
                        return (
                          <tr key={order.id} className="border-t border-black/5 transition hover:bg-[#fcfaf6]">
                            ...
                            <td className="px-6 py-5 text-right">
                              <Link href={`/admin/orders/${order.id}`} className="inline-flex items-center gap-1 rounded-full bg-black px-4 py-2 text-sm font-bold text-white transition hover:bg-black/80">
                    ...
                    return (
                      <article key={order.id} className="rounded-2xl border border-black/8 bg-[#fcfaf6] p-5">
                        ...
                        <div className="mt-5 flex items-end justify-between gap-4">
                          ...
                          <Link href={`/admin/orders/${order.id}`} className="inline-flex items-center gap-1 rounded-full bg-black px-4 py-2 text-sm font-bold text-white">
