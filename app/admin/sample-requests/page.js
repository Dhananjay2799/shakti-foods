...
export default async function SampleRequestsPage({
  ...
  if (countsError) {
    console.error(
      "Unable to load sample request counts:",
      countsError
    );
  }
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-black/55">
            Review free sample requests,
            qualify potential B2B customers,
            approve shipments and manage
            fulfillment.
          </p>
        </div>
            ...
            (filter) => {
              ...
              const href =
                ...
                "all"
                  ...
                  : `/admin/sample-requests?status=${filter.value}`;
